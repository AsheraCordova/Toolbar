...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[24].selector = @selector(getItemViewWithADMenuItem:);
  methods[25].selector = @selector(getOverFlowButton);
  ...
  static const J2ObjcClassInfo _ASActionMenuViewImpl_ActionMenuViewExt = { "ActionMenuViewExt", "com.ashera.toolbar", ptrTable, methods, fields, 7, 0x1, 33, 6, 3, -1, -1, -1, -1 };
