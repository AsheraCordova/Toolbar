...
export abstract class ActionMenuViewImpl<T> extends ViewGroupImpl<T>{
	//start - body
	static initialize() {
...
export class ActionMenuView_LayoutParams extends ActionMenuViewImpl_LayoutParams<ActionMenuView_LayoutParams> implements ILayoutParam {
    getThisPointer(): ActionMenuView_LayoutParams {
        return this;
    }
...
export class ActionMenuView extends ActionMenuViewImpl<ActionMenuView> implements IWidget{
    getThisPointer(): ActionMenuView {
        return this;
    }
